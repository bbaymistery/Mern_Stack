...
import { saveShippingInfo } from "../../redux/cartRedux";
const Shipping = () => {
  ...
  const shippingSubmit = (e) => {
    ...
    if (!address || !city || !country || !pinCode || !phoneNo) {
      return alert("Fill all the blank ")
    }
      ...
      <div style={{ marginTop: "5rem" }}>
        ...
        <div className="shippingContainer">
          <div className="shippingBox">
            ...
            <p style={{ fontWeight: 'bold', textAlign: 'center' }}>Fill all the blank</p>
            <form
            ...
            >
              ...
              <div>
                <PinDropIcon />
                <input placeholder="Pin Code" required value={pinCode} onChange={(e) => setPinCode(e.target.value)} />
              </div>
