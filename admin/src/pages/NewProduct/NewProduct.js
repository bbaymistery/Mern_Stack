...
import { clearErrors, createProduct } from "../../reducers/productsReducer/productAction";
...
import { NEW_PRODUCT_RESET } from "../../reducers/productsReducer/productTypes";
...
const NewProduct = () => {
    ...
    useEffect(() => {
        ...
        if (success) {
            alertAlert.success("Product Created Successfully");
            navigate("/products");
            dispatch({ type: NEW_PRODUCT_RESET });
        }
    }, [dispatch, alertAlert, error, navigate, success]);
    ...
    console.log(imagesPreview, "preview");
                    ...
                    <div className="newProductContainer">
                        <form className="createProductForm" encType="multipart/form-data" onSubmit={createProductSubmitHandler} >
                            ...
                            <div id="createProductFormFile">
                                <input type="file" accept="image/*" name="avatar" onChange={createProductImagesChange} multiple />
                            </div>
