...
const Posts = () => {
    ...
    //load more buttona get ordakini 9 u uc elesen 3dene gozuker
    //eyni zmnda burdakinide 3 elemlisen
    //eyni zmn da postCtrl de de 3 elemelisen

    //!  homePosts.page + 1   e dikkat
