...
const Register = () => {
  ...
  // sadece login olmuyan ucun bu sehfe gorunecek
  useEffect(() => {
  ...
  return (
    <div className="auth_page">
      <form onSubmit={handleSubmit}>
        <h3 className="text-uppercase text-center mb-4">V-Social</h3>
        ...
        <div className="form-group">
          ...
          <small style={{fontSize:"10px"}} className="form-text text-danger">
            {alert.fullname ? alert.fullname : ''}
          </small>
        </div>

        <div className="form-group">
          <label style={{ fontSize: "14px" }} htmlFor="username">User Name</label>
        ...
        <div className="form-group">
          <label style={{ fontSize: "14px" }} htmlFor="exampleInputEmail1">Email address</label>
        ...
        <div className="form-group">
          <label style={{ fontSize: "14px" }} htmlFor="exampleInputPassword1">Password</label>
          ...
          <div className="pass">
            ...
            <small style={{ fontSize: "11px" }} onClick={() => setTypePass(!typePass)}>
              {typePass ? 'Hide' : 'Show'}
            </small>
          </div>

          <small style={{ fontSize: "11px" }} className="form-text text-danger">
            {alert.password ? alert.password : ''}
          </small>
        </div>

        <div className="form-group">
          <label style={{ fontSize: "14px" }} htmlFor="cf_password">Confirm Password</label>
          ...
          <div className="pass">
            ...
            <small style={{ fontSize: "11px" }} onClick={() => setTypeCfPass(!typeCfPass)}>
